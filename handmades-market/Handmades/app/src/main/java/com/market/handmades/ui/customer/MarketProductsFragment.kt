...
class MarketProductsFragment(
    ...
    companion object {
        ...
        fun getInstance(navigation: NavController): MarketProductsFragment =
            MarketProductsFragment(navigation)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.listener = ProductArrayAdapter.IOnClickListener { item ->
            ...
            navigation.navigate(R.id.action_marketViewFragment_to_aboutProductFragmentC)
        }
        ...
        GlobalScope.launch(Dispatchers.IO) {
            ...
            val selectedMarketId = viewModel.selectedMarketId ?: return@launch
